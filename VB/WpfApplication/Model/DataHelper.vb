...
Namespace WpfApplication
    ...
    Public Class DataHelper
        ...
        Public Shared Function GetDataSource(ByVal count As Integer) As Object
            ...
            For i As Integer = 0 To count - 1
                collection.Add(New GridItem(i Mod 3 <> 0, Date.Now.AddMinutes(count * i).AddDays((i - count \ 2) * count), String.Format("Name{0}", i), i))
            Next
    ...
    Public Class GridItem
        ...
        ''' <param name="iD"></param>
        Public Sub New(ByVal allowEdit As Boolean, ByVal [date] As Date, ByVal name As String, ByVal iD As Integer)
